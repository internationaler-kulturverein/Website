...
export const tuneOffsets = '0,0,0,5,0,3,0,0,0'; // Beispiel: Dhuhur +5 Min, Maghreb +3 Min, Isha +18 Min
...
export const MANUAL_SETTINGS = {
    ...
    START_HIJRI_MONTH_KEY: "Safar",
    // Das islamische Jahr.
    START_HIJRI_YEAR: 1448,
    ...
    START_GREGORIAN_DATE_STR: "2026-07-15",
};
